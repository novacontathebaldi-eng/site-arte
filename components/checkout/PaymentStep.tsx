  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-md">
      ...
      <div className="space-y-4">
        {/* Credit Card Option */}
        <label className={`flex items-start p-4 border rounded-md cursor-pointer ${paymentMethod === 'creditCard' ? 'border-brand-gold ring-2 ring-brand-gold' : ''}`}>
        ...
        {/* PIX Option */}
        <label className={`flex items-start p-4 border rounded-md cursor-pointer ${paymentMethod === 'pix' ? 'border-brand-gold ring-2 ring-brand-gold' : ''}`}>
