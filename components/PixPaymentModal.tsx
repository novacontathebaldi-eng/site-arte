    ...
    useEffect(() => {
        ...
        const unsubscribe = db.collection('orders').doc(order.id)
            .onSnapshot(doc => {
                ...
                // FIX: Changed check from 'paid_online' to 'paid' to match PaymentStatus type.
                if (updatedOrderData && (updatedOrderData.paymentStatus === 'paid' || updatedOrderData.paymentStatus === 'paid_online')) {
