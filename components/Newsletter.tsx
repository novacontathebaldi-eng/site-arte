...
const Newsletter: React.FC = () => {
    ...
    return (
        <div className="bg-brand-black/5">
            <div className="mx-auto max-w-4xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
                <h2 className="text-3xl font-serif font-bold text-brand-black">{t('newsletter.title')}</h2>
                <p className="mt-2 text-lg text-brand-black/70">{t('newsletter.subtitle')}</p>
