...
const DashboardPage: React.FC = () => {
    ...
    const stats: { title: string; value: string; icon: React.ReactNode; change: string; changeType: 'increase' | 'decrease' }[] = [
        { title: t('admin.dashboard.totalSales'), value: '€12,842', icon: <DollarSignIcon />, change: '+12.5%', changeType: 'increase' },
        { title: t('admin.dashboard.totalOrders'), value: '142', icon: <ShoppingCartIcon />, change: '+8.1%', changeType: 'increase' },
        { title: t('admin.dashboard.totalCustomers'), value: '89', icon: <UsersIcon />, change: '+2', changeType: 'increase' },
    ];
        ...
        <div>
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-brand-white p-6 rounded-lg shadow">
                    <h3 className="font-bold font-serif">{t('admin.dashboard.salesOverview')}</h3>
                 ...
                 <div className="bg-brand-white p-6 rounded-lg shadow">
                    <h3 className="font-bold font-serif">{t('admin.dashboard.recentActivity')}</h3>
