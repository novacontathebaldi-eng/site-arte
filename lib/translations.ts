...
export const translations: Record<Language, Record<string, any>> = {
  ...
  de: {
    ...
    checkout: {
      ...
      pixInstructions: 'Scannen Sie den QR-Code oder kopieren Sie den folgenden Code, um zu bezahlen.',
    ...
    order: {
      confirmationTitle: 'Vielen Dank für Ihre Bestellung!',
      confirmationSubtitle: 'Eine Bestätigungs-E-Mail wurde gesendet.',
      details: 'Bestelldetails',
      paymentPending: 'Zahlung ausstehend',
      paymentPendingInstructions: 'Ihre Bestellung wurde erstellt. Bitte schließen Sie die Zahlung ab, damit wir sie vorbereiten können.',
    },
    dashboard: {
      nav: {
        home: 'Startseite',
  ...
  pt: {
    ...
    cart: {
      ...
      uniqueItemError: 'Este item exclusivo já está no seu carrinho.',
      remove: 'Remover',
    },
    wishlist: {
    ...
    order: {
      ...
      paymentPendingInstructions: 'Seu pedido foi criado. Por favor, complete o pagamento para que possamos prepará-lo.',
    },
    dashboard: {
      nav: {
        home: 'Início',
    ...
    admin: {
      ...
      dashboard: {
        ...
        lowStock: 'Alertas de Estoque Baixo',
      ...
      orders: {
        ...
        trackingAdded: 'Rastreio adicionado',
      },
      customers: {
      ...
      discounts: {
        ...
        form: {
            ...
            value: 'Valor',
            valueHelpPercentage: 'Digite um valor numérico (ex: 10 para 10%)',
            valueHelpFixed: 'Digite um valor em centavos (ex: 1000 para €10)',
