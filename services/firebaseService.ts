...
import { Painting as Product, Category, SiteSettings, Order, OrderStatus, PaymentStatus, OrderDetails, CartItem, ChatMessage, ReservationDetails, UserProfile, Address, DaySchedule } from '../types';
...
// FIX: Added 'pickupTimeEstimate' to the payload type to match the updated Order type.
